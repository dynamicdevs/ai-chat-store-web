  ...
  return (
    <header className='fixed top-0 left-0 z-20 w-full bg-core-default-inverted shadow-01'>
      ...
      <GridWrapper className='h-22'>
        <div className='flex items-center justify-between col-span-full xl:col-span-3'>
          ...
          <div className='flex items-center gap-6 xl:hidden'>
            ...
            <div className='relative'>
              ...
              <Icon name='ic_cart' className='w-6 h-6' />
            </div>
          </div>
        </div>
        <div className='items-center hidden xl:flex xl:col-span-6 xl:col-start-4'>
          <Search
        ...
        <div className='items-center hidden gap-5 xl:flex xl:col-span-2 xl:col-start-11'>
